...
" syntax match hsElem    "`elem`"            conceal cchar=∈
" syntax match hsNot     "not "              conceal cchar=¬
" syntax match hsAnd     "&&"                conceal cchar=∧
" syntax match hsOr      "||"                conceal cchar=∨
" syntax match hsMul     "*"                 conceal cchar=·
